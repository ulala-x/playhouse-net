...
echo -e "  ${YELLOW}C#${NC}:         HTTP 18080, TCP 18001"
echo -e "  ${YELLOW}Java${NC}:       HTTP 28080, TCP 28001"
echo -e "  ${YELLOW}JavaScript${NC}: HTTP 38080, WS  38080"
echo -e "  ${YELLOW}C++${NC}:        HTTP 48080, TCP 48001"
echo ""
