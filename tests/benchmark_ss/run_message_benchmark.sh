...
# PlayHouse S2S Benchmark - Message-count-based Test
# 사용법: ./run_message_benchmark.sh [connections] [messages]
# 각 모드별로 정해진 메시지 수만큼 실행하며 모든 메시지 사이즈를 테스트합니다.
...
echo "================================================================================"
echo "PlayHouse S2S Benchmark - Message-count-based Test"
echo "================================================================================"
echo "Configuration:"
...
echo "[4/4] Running S2S benchmarks (message-count-based)..."
echo ""
...
echo ""
echo "================================================================================"
echo "S2S Message-count-based Benchmark completed"
