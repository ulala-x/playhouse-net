...
2. `03-stage-actor-model.md` - 핵심 프로그래밍 모델 학습
3. `07-client-protocol.md` - 클라이언트 연동 방법
4. `04-timer-system.md` - 주기적 작업 처리 방법
5. 나머지 문서 - 필요에 따라 참조

### 백엔드 개발자
1. `00-overview.md` - 개요
2. `01-architecture.md` - 시스템 아키텍처
3. `02-packet-structure.md` - 패킷 구조
4. `03-stage-actor-model.md` - Stage/Actor 모델
5. `06-socket-transport.md` - 소켓 구현
6. `05-http-api.md` - HTTP API

### 클라이언트 개발자
1. `00-overview.md` - 개요
2. `07-client-protocol.md` - 클라이언트 프로토콜
3. `02-packet-structure.md` - 패킷 구조
4. `03-stage-actor-model.md` - Stage/Actor 이해
